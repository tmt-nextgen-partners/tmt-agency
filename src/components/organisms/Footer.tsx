        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center">
              ...
              <H5 className="text-lg font-bold text-primary">TMT NextGen Partners</H5>
            </div>
          ...
          {/* Business Hours */}
          <div className="space-y-6">
            <H5 className="text-lg font-bold text-primary">Business Hours</H5>
          ...
          {/* Certifications */}
          <div className="space-y-6">
            <H5 className="text-lg font-bold text-primary">Certifications</H5>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
